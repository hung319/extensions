...
data class KitsuAttributes(val canonicalTitle: String?, val posterImage: KitsuPoster?)
data class KitsuPoster(val original: String?, val large: String?, val medium: String?, val small: String?, val tiny: String?)
...
class AnimeHayProvider : MainAPI() {
    ...
    // =================================================================================================
    // *** PHIÊN BẢN HOÀN CHỈNH - SẼ CHẠY KHI CÓ PLUGIN KÈM THEO ***
    // =================================================================================================
    ...
    override fun getVideoInterceptor(extractorLink: ExtractorLink): Interceptor? {
        return Interceptor { chain ->
            ...
            if (needsFix) {
                Log.d("AnimeHayProvider", "Interceptor đang giải mã XOR trên URL: $url")
                ...
                try {
                    ...
                    Log.e("AnimeHayProvider", "Interceptor thất bại khi giải mã", e)
                }
            }
            response
        }
