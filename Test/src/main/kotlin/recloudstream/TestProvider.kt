...
// Author: Coder
// Date: 2025-07-26
// Version: 4.1 (Fix load function selector)
...
class Phevkl : MainAPI() {
    ...
    private fun Element.toSearchResult(): SearchResponse? {
        ...
        // Sử dụng src trực tiếp vì lazyload có thể không kích hoạt, data-src là fallback
        val posterUrl = this.selectFirst("img.video-image")?.let { it.attr("src").ifEmpty { it.attr("data-src") } }
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        // ======================= FIX =======================
        // Tiêu đề nằm trong thẻ h2#page-title, không phải h1
