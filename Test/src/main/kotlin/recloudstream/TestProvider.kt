...
class AnimeVietsubProvider : MainAPI() {
    ...
    // =================== Hàm getMainPage đã được tối ưu hóa ===================
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        try {
            ...
            // Sử dụng coroutineScope để chạy các tác vụ phân tích HTML song song
            val lists = coroutineScope {
                // Mỗi khối 'async' này sẽ chạy đồng thời trên một luồng khác nhau.
                // Điều này giúp tăng tốc quá trình lấy dữ liệu từ document.
                ...
                // Chờ tất cả các tác vụ async hoàn thành và thu thập kết quả.
                // listOfNotNull sẽ lọc ra các kết quả null (nếu có lỗi xảy ra ở một tác vụ).
